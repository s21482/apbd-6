...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task2()
        {
            ...
            return Emps.Where(e => e.Job == "Frontend programmer" && e.Salary > 1000).OrderByDescending(e => e.Ename);
        }
        ...
        {
            return Emps.Where(e => e.Salary == Task3());
        }
        ...
        {
            return Emps.Join(Depts, e => e.Deptno, d => d.Deptno, (e, d) => new { e.Ename, e.Job, d.Dname });
        }
        ...
        {
            return Emps.GroupBy(e => e.Job).Select(e => new { Praca = e.Key, LiczbaPracownikow = e.Count() });
        }
        ...
        {
            return Emps.Where(e => e.Job == "Frontend programmer").OrderByDescending(e => e.HireDate).FirstOrDefault();
        }
        ...
        {
            return Depts
              .GroupJoin(Emps, dept => dept.Deptno, emp => emp.Deptno, (Dept, GroupEmps) => new { Dept, GroupEmps })
              .Where(d => d.GroupEmps.Count() == 5 || d.GroupEmps.Count() == 0)
              .Select(d => d.Dept)
              .OrderBy(d => d.Dname);
        }
    }
